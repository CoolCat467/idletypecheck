...
- Use idletypecheck in a project, and give us feedback on what worked and what
  didn't.
- Write a blog post about your experiences with idletypecheck, good or bad.
...
idletypecheck is developed on GitHub. Code
...
When helping others use idletypecheck, please remember that you are
...
doing Y, idletypecheck does Z instead, which I prefer because...") or talk
